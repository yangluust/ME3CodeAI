"""Side-by-side parity gate: ME_FLP_V6scc_Enhance2 (Phase 2) vs ME_FLP_V6scc_Enhance3 (Phase 3)."""
...
import ME_FLP_V6scc_Enhance2 as ref_pkg
import ME_FLP_V6scc_Enhance3 as new_pkg

from ME_FLP_V6scc_Enhance2.config import load_run_config
from ME_FLP_V6scc_Enhance2.solver import SolverOptions as RefSolverOptions
from ME_FLP_V6scc_Enhance3.solver import SolverOptions as NewSolverOptions
...
def main() -> None:
    p = argparse.ArgumentParser(description="Phase2 vs Phase3 parity gate (in-process).")
    ...
    print("\n[ref] running ME_FLP_V6scc_Enhance2.run_model (Phase 2) ...")
    ...
    print("\n[new] running ME_FLP_V6scc_Enhance3.run_model (Phase 3) ...")
    t0 = time.perf_counter()
    ...
    print("\nmax-abs diffs (phase3 vs phase2):")
    ...
    print(f"\nspeedup (phase2 / phase3): {speedup:.3f}x")
