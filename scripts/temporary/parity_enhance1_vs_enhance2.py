"""Side-by-side parity gate: ME_FLP_V6scc_Enhance (Phase 1) vs ME_FLP_V6scc_Enhance2 (Phase 2)."""
...
import ME_FLP_V6scc_Enhance as ref_pkg
import ME_FLP_V6scc_Enhance2 as new_pkg

from ME_FLP_V6scc_Enhance.config import load_run_config
from ME_FLP_V6scc_Enhance.solver import SolverOptions as RefSolverOptions
from ME_FLP_V6scc_Enhance2.solver import SolverOptions as NewSolverOptions
...
def main() -> None:
    p = argparse.ArgumentParser(description="Phase1 vs Phase2 parity gate (in-process).")
    ...
    print("\n[ref] running ME_FLP_V6scc_Enhance.run_model (Phase 1) ...")
    ...
    print("\n[new] running ME_FLP_V6scc_Enhance2.run_model (Phase 2) ...")
    t0 = time.perf_counter()
    ...
    print("\nmax-abs diffs (phase2 vs phase1):")
    ...
    print(f"\nspeedup (phase1 / phase2): {speedup:.3f}x")
