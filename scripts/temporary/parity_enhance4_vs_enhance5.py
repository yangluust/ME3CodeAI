"""Side-by-side parity gate: ME_FLP_V6scc_Enhance4 (Phase 4) vs ME_FLP_V6scc_Enhance5 (Phase 5)."""
...
import ME_FLP_V6scc_Enhance4 as ref_pkg
import ME_FLP_V6scc_Enhance5 as new_pkg

from ME_FLP_V6scc_Enhance4.config import load_run_config
from ME_FLP_V6scc_Enhance4.solver import SolverOptions as RefSolverOptions
from ME_FLP_V6scc_Enhance5.solver import SolverOptions as NewSolverOptions
...
def main() -> None:
    p = argparse.ArgumentParser(description="Phase4 vs Phase5 parity gate (in-process).")
    ...
    print("\n[ref] running ME_FLP_V6scc_Enhance4.run_model (Phase 4) ...")
    ...
    print("\n[new] running ME_FLP_V6scc_Enhance5.run_model (Phase 5) ...")
    t0 = time.perf_counter()
    ...
    print("\nmax-abs diffs (phase5 vs phase4):")
    ...
    print(f"\nspeedup (phase4 / phase5): {speedup:.3f}x")
